#################################################################
#                                                               #
# CORE-Server Setup, Netadapter, Partitionieren & Formatieren   #
# CORE-Server der Domäne hinzufügen                             #
#                                                               #
#                                                               #
# Achtung! Die OU "All-Server" muss erstellt worden sein!       #
#                                                               #
#################################################################
...
#Domäne beitreten (Die OU "All-Server" muss erstellt worden sein)
   $DomTop = "local"
   $DomSub = "kmsystem"
